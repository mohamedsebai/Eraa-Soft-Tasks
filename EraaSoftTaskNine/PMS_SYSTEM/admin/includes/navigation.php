    ...
    <div class="container">
      <div class="row">
        ...
        <?php if(isset($_SESSION['user_id'])): ?>
          ...
          <a class="nav-link d-inline-block" href="orders.php">Orders</a>
          <a class="nav-link d-inline-block" href="categories.php">Categories</a>
          <a class="nav-link d-inline-block" href="products.php">Products</a>
